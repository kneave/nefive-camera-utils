...
class StereoConfigHandler:
    ...
    def handleKeypress(key, stereoDepthConfigInQueue):
        ...
        if key == ord("a"):
            ...
            config_output = {"median": StereoConfigHandler.config.postProcessing.median, 
                             "spatialFilter": StereoConfigHandler.config.postProcessing.spatialFilter.enable,
                             "temporalFilter": StereoConfigHandler.config.postProcessing.temporalFilter.enable,
                             "persistencyMode":  StereoConfigHandler.config.postProcessing.temporalFilter.persistencyMode,
                             "speckleFilter": StereoConfigHandler.config.postProcessing.speckleFilter.enable,
                             "decimationMode": StereoConfigHandler.config.postProcessing.decimationFilter.decimationMode,
                             "costMatchCompanding": StereoConfigHandler.config.costMatching.enableCompanding,
                             "censusTransformMeanMode": StereoConfigHandler.config.censusTransform.enableMeanMode,
                             "lrCheck": StereoConfigHandler.config.algorithmControl.enableLeftRightCheck,
                             "subpixel": StereoConfigHandler.config.algorithmControl.enableSubpixel,
                             "extended": StereoConfigHandler.config.algorithmControl.enableExtended,
                             "alignment": StereoConfigHandler.config.algorithmControl.depthAlign,
                             "disparityWidth": StereoConfigHandler.config.costMatching.disparityWidth,
                             "decimationMode": StereoConfigHandler.config.postProcessing.decimationFilter.decimationMode,
                             "confidenceThreshold": StereoConfigHandler.config.costMatching.confidenceThreshold,
                             "bilateralSigmaValue": StereoConfigHandler.config.postProcessing.bilateralSigmaValue,
                             "lrCheckThreshold": StereoConfigHandler.config.algorithmControl.leftRightCheckThreshold,
                             "subpixelFractionalBits": StereoConfigHandler.config.algorithmControl.subpixelFractionalBits,
                             "disparityShift": StereoConfigHandler.config.algorithmControl.disparityShift,
                             "centerAlignShiftFactor": StereoConfigHandler.config.algorithmControl.centerAlignmentShiftFactor,
                             "numInvalidatedEdgePixels": StereoConfigHandler.config.algorithmControl.numInvalidateEdgePixels,
                             "costMatchingLinearEquationParametersAlpha": StereoConfigHandler.config.costMatching.linearEquationParameters.alpha,
                             "costMatchingLinearEquationParametersBeta": StereoConfigHandler.config.costMatching.linearEquationParameters.beta,
                             "costMatchingLinearEquationParametersThreshold": StereoConfigHandler.config.costMatching.linearEquationParameters.threshold,
                             "costAggregationHorizontalPenaltyCostP1": StereoConfigHandler.config.costAggregation.horizontalPenaltyCostP1,
                             "costAggregationHorizontalPenaltyCostP2": StereoConfigHandler.config.costAggregation.horizontalPenaltyCostP2,
                             "postProcessingTemporalFilterAlpha":StereoConfigHandler.config.postProcessing.temporalFilter.alpha,
                             "postProcessingTemporalFilterDelta": StereoConfigHandler.config.postProcessing.temporalFilter.delta,
                             "postProcessingSpatialFilterAlpha": StereoConfigHandler.config.postProcessing.spatialFilter.alpha,
                             "postProcessingSpatialFilterDelta": StereoConfigHandler.config.postProcessing.spatialFilter.delta,
                             "postProcessingSpatialFilterHoleFillingRadius":StereoConfigHandler.config.postProcessing.spatialFilter.holeFillingRadius,
                             "postProcessingSpatialFilterNumIterations": StereoConfigHandler.config.postProcessing.spatialFilter.numIterations,
                             "postProcessingThresholdFilterMinRange":StereoConfigHandler.config.postProcessing.thresholdFilter.minRange,
                             "postProcessingThresholdFilterMaxRange": StereoConfigHandler.config.postProcessing.thresholdFilter.maxRange,
                             "postProcessingSpeckleFilterSpeckleRange": StereoConfigHandler.config.postProcessing.speckleFilter.speckleRange,
                             "postProcessingDecimationFilterDecimationFactor": StereoConfigHandler.config.postProcessing.decimationFilter.decimationFactor
                             }
            print(config_output)
...
# Linking
if(args.swapLR):
    colorLeft.isp.link(stereo.right)
    colorRight.isp.link(stereo.left)
else:
